...
/*
* Data structure for representing a Spork profile for restauarant/business. 
* businessName is the name of the restauarant/business. 
* locX and locY are the x and y coordinates of the business.
* avgRating is the average rating for the business. 
* adLevel is a value ranging from 0 to 2 describing the business advertising level. 
* isNearby is used to indicate if the business is near the user's location. 
* isGood indicates if the business is greater than or equal to the user's minimum desired rating.
*
*/
